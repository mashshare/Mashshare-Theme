...
class rootstrap_popular_posts_widget extends WP_Widget {
        ...
        <div class="widget tabbed">
            ...
            <div class="tab-content">
                ...
                <?php foreach($recent_comments as $comment) : ?>
                    ...
                    <li>
                        <div class="content">
                            <?php if ( $comment->comment_author ) { echo $comment->comment_author; } else { _e('Anonymous','rootstrap'); } ?> <?php _e('on','rootstrap'); ?> 
	...
	function form( $instance ) {
		...
		<!-- Number of posts -->
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e('Number of posts to show','rootstrap') ?>:</label>
